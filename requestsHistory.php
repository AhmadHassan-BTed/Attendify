...
<head>
    ...
    <title>Requests History - AU Attendance Portal</title>
...
<body>
    ...
    <div class="main-content">
        <header>
            <div class="header-left">
                <h2>All Leave Requests History</h2>
                <p>View all historical leave applications and their current statuses</p>
            </div>
            <div class="header-right">
                <button class="icon-btn" onclick="fetchAllLeaves()"><i class='bx bx-refresh' style="font-size: 1.2rem;"></i></button>
        ...
        <div class="grid-container">
            <div class="grid-header">
                <div class="search-mini" style="background:#F4F7FE; padding:8px 15px; border-radius:20px; display: flex; align-items: center;">
                    ...
                    <input type="text" id="filterTextBox" oninput="onFilterTextBoxChanged()" placeholder="Search History..." style="border:none; background:transparent; outline:none; margin-left:5px;">
                </div>
            </div>
    ...
    <script>
        ...
        const columnDefs = [
            { headerName: 'Date', field: 'leave_date', flex: 0.8, filter: true, sort: 'desc' }, // Added Date Column
        ...
        function fetchAllLeaves() {
            // Fetch ALL leaves, no date filter
            const url = `api.php?action=getAllLeavesHistory&th_regId=${th_regId}`;
